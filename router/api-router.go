...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/login/admin", middleware.CriticalRateLimit(), controller.AdminLogin)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/balances", controller.GetAllUserBalances)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.PUT("/self/:id/hourly-limit", controller.UpdateSubscriptionHourlyLimit)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/ability", controller.GetAbilityList)
			...
			channelRoute.POST("/batch/probe", controller.BatchSetChannelProbe)
