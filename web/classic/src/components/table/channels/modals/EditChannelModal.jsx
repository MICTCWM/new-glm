            ...
            const advancedSettingsContent = (
              <div className='space-y-4'>
                ...
                <div className='pt-3'>
                  ...
                  <Form.Switch
                    field='gpt_mode_required'
                    label={t('GPT 专用渠道')}
                    checkedText={t('开')}
                    uncheckedText={t('关')}
                    onChange={(value) =>
                      handleChannelSettingsChange('gpt_mode_required', value)
                    }
                    extraText={t('开启后，仅 GPT 模式用户可使用该渠道。')}
                  />
                  <Form.Switch
                    field='emergency_plan_enabled'
                    label={t('应急预案')}
                    checkedText={t('开')}
                    uncheckedText={t('关')}
                    onChange={(value) =>
                      handleChannelSettingsChange(
                        'emergency_plan_enabled',
                        value,
                      )
                    }
                    extraText={t(
