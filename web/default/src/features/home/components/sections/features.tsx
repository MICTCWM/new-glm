...
export function Features(_props: FeaturesProps) {
  ...
  const features = [
    ...
    },
    {
      ...
      span: 'md:col-span-1',
      icon: <Shield className='size-4 text-rose-500 dark:text-rose-400' />,
      visual: (
    ...
    },
    {
      ...
      span: 'md:col-span-1',
      icon: <Globe className='size-4 text-orange-500 dark:text-orange-400' />,
      visual: (
    ...
    },
    {
      ...
      span: 'md:col-span-2',
      icon: <Code className='size-4 text-orange-600 dark:text-orange-400' />,
      visual: (
