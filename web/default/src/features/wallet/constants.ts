...
/**
 * GPT wallet transfer exchange rate:
 * 500 base balance = 1.5 GPT balance
 * base = gpt * (500000000 / 3)
 */
export const GPT_TO_BASE_RATIO = 500000000 / 3

/**
 * GPT wallet transfer exchange rate:
 * 500 base balance = 1.5 GPT balance
 * gpt = base * (3 / 500000000)
 */
export const BASE_TO_GPT_RATIO = 3 / 500000000
