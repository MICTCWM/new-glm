...
type TaskPrivateData struct {
	...
	SubscriptionTargetGroup       string              `json:"subscription_target_group,omitempty"`
	SubscriptionIsGroupRestricted bool                `json:"subscription_is_group_restricted,omitempty"`
