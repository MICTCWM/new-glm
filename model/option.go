...
func InitOptionMap() {
	...
	common.OptionMap["RegionBlockEnabled"] = strconv.FormatBool(common.RegionBlockEnabled)
	...
	common.OptionMap["DailyUsageLimit"] = strconv.Itoa(common.DailyUsageLimit)
	...
	common.OptionMap["LimitedInputTokenChannelIds"] = common.LimitedInputTokenChannelIDsJSONString()
	...
	common.OptionMap["ModelNoImageModels"] = operation_setting.ModelNoImageModelsToString()
	common.OptionMap["VisionRouteModels"] = operation_setting.VisionRouteModelsToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "RegionBlockEnabled":
			common.RegionBlockEnabled = boolValue
	...
	case "DailyUsageLimit":
		common.DailyUsageLimit, _ = strconv.Atoi(value)
	...
	case "LimitedInputTokenChannelIds":
		err = common.UpdateLimitedInputTokenChannelIDs(value)
	...
	case "ModelNoImageModels":
		operation_setting.ModelNoImageModelsFromString(value)
	case "VisionRouteModels":
		operation_setting.VisionRouteModelsFromString(value)
